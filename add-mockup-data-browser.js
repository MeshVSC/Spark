// Copy and paste this into your browser console after signing in to your local app
...
async function addMockupData() {
  try {
    ...
    // Get supabase client from window (should be available in React app)
    if (!window.supabase) {
      console.error('Supabase client not found. Make sure you are on the Spark app page.')
      return
    }
